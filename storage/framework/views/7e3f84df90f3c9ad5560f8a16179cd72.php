      ...
      >
        <div class="py-6 px-6 flex flex-col h-full">
          ...
          <nav class="flex flex-col space-y-1 flex-grow">
            ...
            <!-- Patient Management -->
            <div
              x-data="{ open: <?php echo e(request()->routeIs('register_patients') || request()->routeIs('patients.index') || request()->routeIs('patients.history') ? 'true' : 'false'); ?> }"
              class="relative"
            >
              <button
                @click="open = !open"
              ...
              >
                <li>
                  <a
                    href="<?php echo e(route('register_patients')); ?>"
                ...
                <li>
                  <a
                    href="<?php echo e(route('patients.history')); ?>"
                    class="block px-3 py-2 rounded hover:bg-purple-100 hover:text-purple-700 dark:hover:bg-gray-800 dark:hover:text-purple-400"
                  >
                    History
                  </a>
            ...
            <a
              ...
              aria-current="<?php echo e(request()->routeIs('admin.appointments.index') ? 'page' : false); ?>"
            >
              <svg
                class="w-5 h-5 mr-3"
                fill="none"
            ...
            <a
              ...
              aria-current="<?php echo e(request()->routeIs('inventory.index') ? 'page' : false); ?>"
            >
              <svg
                class="w-5 h-5 mr-3"
                fill="none"
            ...
            <a
              ...
              aria-current="<?php echo e(request()->routeIs('reports.index') ? 'page' : false); ?>"
            >
              <svg
                class="w-5 h-5 mr-3"
                fill="none"
